...
public class DeliveryInternalController {
    ...
    public ApiResponse<List<DeliveryCreateResponse>> createInternalDeliveries(@Valid @RequestBody List<DeliveryCreateClientRequest> requests, @RequestHeader(value = "X-User-Id", required = false, defaultValue = "c7e2b1a0-5678-4def-9012-3456789abcde") String userId) {
        List<DeliveryCreateResponse> responses = deliveryService.createInternalDeliveries(requests, userId);
